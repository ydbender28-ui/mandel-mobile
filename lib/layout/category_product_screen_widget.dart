...
class CategoryProductScreenWidget extends StatefulWidget {
  final CategoryDto categoryDto;

  const CategoryProductScreenWidget({super.key, required this.categoryDto});

  @override
  State<CategoryProductScreenWidget> createState() =>
      _CategoryProductScreenWidgetState();
}

class _CategoryProductScreenWidgetState
    extends State<CategoryProductScreenWidget> {
  //
  ...
  ///
  ///This method will return product list by filter from category
      ...
      body: Stack(
        ...
        children: [
          Column(
            ...
            children: [
              _buildTitle(widget.categoryDto.name!),
              _buildFilterField(),
              Expanded(
                  child: Column(
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Container(
          ...
          child: Center(
              child: Image.network(
            CommonConstants.mandelImageBaseUrl + productImageUrl,
